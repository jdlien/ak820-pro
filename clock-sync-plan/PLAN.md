...
Companion docs: `hardening-plan/` (conventions, health counters, soak
...
| Docs | board `readme.md`, `docs/clock.md`, `hardening-plan/HARDWARE-CHECKLIST.md`, `BACKLOG.md` | supersede "±2 s is the design bound", "~1 s is the hard floor", "3 h resync"; add Phase 0 constants. |
...
Exit: `clock-sync-plan/phase-0-facts.md` with every number. Gate: §6
