...
**Phase 1 is written** (2026-09-06) — `text/`, `smtc/`, `ak820 probe`. 98 unit
tests plus a 2,158-case parity fixture generated by calling
`ak820text.to_ascii` itself. Its gate is not closed: the ranking and timeline
rules are covered synthetically, but **captured** sessions from a real desktop
are still wanted, which needs something playing.
