...
| **2** macOS clock | this commit | 🟡 offline half built: the replay over this Mac's own timekeeper log (1,469 learned, 605 holds, 2,072 carried syncs, 2,077 intervals), time zones against `zoneinfo`, `ak820 clock` read-only with a fail-closed refusal. Live half owed |
