...
//!
//! The windows-subsystem attribute itself sits on `src/bin/ak820-agent.rs`,
//! the one declared `#[cfg]` in a shared file: an inner attribute belongs to
//! the crate root, and this body is a module.
